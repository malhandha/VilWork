        ...
        <div class="mainpelatihan">
            <div class="konten">
                <div class="poster">
                    ...
                    <div class="overlay">
                        <div class="badge badge-right">12 November 2025</div>
                        <a href="pendaftaran_pelatihan.php" class="beli">Daftar Sekarang</a>
                        <div class="bottom-overlay">
                            <h1 class="title-konten">Belajar Micosoft Ofice</h1>
                            <div class="formats">
                                <i class="ri-time-line"></i>Jumat, 12 November 2025
                            </div>
                            <div class="formats">
                                <i class="ri-calendar-todo-line"></i>10.00 - 13.00 WIB
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="konten">
                <div class="poster">
                    <img src="foto/tanipelatihan.jpg" alt="tanipelatihan" class="poster-img">
                    <div class="overlay">
                        <div class="badge badge-right">12 November 2025</div>
                        <a href="pendaftaran_pelatihan.php" class="beli">Daftar Sekarang</a>
                        <div class="bottom-overlay">
